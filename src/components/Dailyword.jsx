    ...
    return(
        <div className="flex flex-col gap-2 w-full mb-5 h-max px-4 md:px-6 z-20">
            ...
            <div className="flex gap-5">
                ...
                <span className="text-[16px] border-2 h-[30px] border-[#6200EA] flex justify-center items-center py-1 px-2 rounded-full"># <i>{wordExist ? wordTranscription[0] : <span>no transcription</span> }</i> #</span>
            </div>
