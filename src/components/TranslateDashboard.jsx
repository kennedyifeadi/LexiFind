...
export const TranslateDashboard = ({ text, icon, title, color }) => {
  ...
  return (
    <div className='flex relative w-[25%] h-max'>
    <div className="flex w-[100%] flex-col justify-between duration-500 ease-in-out cursor-pointer active:scale-75 p-4 shadow-md bg-white rounded-md h-[200px]" onClick={handleClick}>
